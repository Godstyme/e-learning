  ...
  <div class="row align-items-center" style="margin: 0 auto;">
    <div class="col-md-6 offset-md-3 text-dark">
      <div class="card card-body">
          <h4 class="card-title text-center">Upload Video or Audio</h4>
          <form method="post" class="form-horizontal m-t-30" id="uploadMedia" enctype="multipart/form-data">
            <div class="mb-3">        
              <?php
            ...
            <div class="mb-3">
              <label for="exampleFormControlTextarea1" class="form-label">Media</label>
              <div>
